...
exports.run = async (client, message, args) => {      
 ...
 let member = message.guild.member(message.mentions.members.first() || message.guild.members.cache.get(args[0]));
        ...
        if(args[1] === "yetki1") {
                ...
                message.channel.send(embed.setDescription(`Kullanıcı 1. yetkiye yükseltildi. Kullanıcıya <@&ID>, <@&ID>, <@&ID> rolleri verildi!`))
        ...
        if(args[1] === "yetki2") {
                ...
                message.channel.send(embed.setDescription(`Kullanıcı 2. yetkiye yükseltildi. Kullanıcıya <@&ID>, <@&ID>, <@&ID> rolleri verildi!`))
        ...
        if(args[1] === "yetki3") {
                ...
                message.channel.send(embed.setDescription(`Kullanıcı 3. yetkiye yükseltildi. Kullanıcıya <@&ID>, <@&ID>, <@&ID> rolleri verildi!`))
